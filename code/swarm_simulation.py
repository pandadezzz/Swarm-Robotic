...
class World():
    def __init__(self):
        ...
        #Added for project. a list to store all obstacle information. obstacle size is (2,0.15,0.5) L,W,H as given in walls.sdf . The 4th element is 0 if horitonal and 1 if vertical
        obstacles =[[0., -1., 0,0],[0., 1., 0,0],[3., -1., 0,0],[3., 1., 0,0],[1., 2., 0,1],[2., -2., 0,1],[-1., 5., 0,1],[-1., 6., 0,1]]
        ...
        for (i,j) in itertools.product(range(3), range(2)):
            self.robots.append(Robot([1. * i + 0.5, 1. * j - 0.5, 0.3], 2*i+j, self.dt,obstacles))
            p.stepSimulation()
